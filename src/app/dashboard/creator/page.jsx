import GrowthMetricsChart from "@/components/Dashboard/creators/GrowthMetricsChart";
import PromptAnalyticsChart from "@/components/Dashboard/creators/PromptAnalyticsChart";
...
const CreatorAnalytics = async () => {
  ...
  return (
    <section className="w-full min-h-screen bg-[#ebdcc9] text-[#2c221e] p-8">
      ...
      <div className="my-8">
        <PromptAnalyticsChart prompts={data.prompts} />
      </div>
      <div>
        <GrowthMetricsChart
