...
const PromptsCard = ({ cardData }) => {
    return (
        <div className="w-full bg-white/20 backdrop-blur-md rounded-[24px] border border-[#dfcbaf] p-4 flex flex-col justify-between h-full shadow-[0_4px_20px_rgba(44,34,30,0.02)] hover:shadow-[0_10px_30px_rgba(44,34,30,0.08)] transition-all duration-300 group ">
            ...
            <div className="flex flex-col flex-grow">
                ...
                <div className="space-y-3 flex-grow flex flex-col">
                    ...
                    <div className="space-y-2 flex-grow">
                        <h3 className="text-lg font-black tracking-tight leading-snug text-[#2c221e] line-clamp-1">
                            {cardData.title}
                        </h3>
                    ...
                    <div className="flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-wider text-[#2c221e]/50 pt-1 mt-auto">
            ...
            <div className="space-y-3 pt-3 border-t border-[#dfcbaf] mt-4">
                ...
                <Link href={`/all-prompts/${cardData._id}`} className="block w-full">
