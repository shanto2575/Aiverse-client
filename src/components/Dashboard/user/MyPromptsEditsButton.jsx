                            ...
                            <Modal.Body className="p-6 bg-[#ebdcc9]">
                                <Surface variant="default" className="bg-transparent shadow-none p-0">
                                    <form onSubmit={onSubmit} className="flex flex-col gap-5">
                                        ...
                                        {/* DYNAMIC DROPDOWN SELECT MATRIX */}
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <select required name="difficulty" className={baseInputStyle} defaultValue={item.difficulty}>
                                        ...
                                        <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#dfcbaf] mt-2">
                                            <Button
                                                type="submit"
                                                disabled={loading}
                                                className="w-full bg-[#2c221e] text-[#ebdcc9] hover:bg-[#4a3b35] font-bold uppercase tracking-widest h-12 rounded-xl shadow-md transition-all duration-300 flex items-center justify-center gap-1.5 group text-xs cursor-pointer disabled:opacity-50"
                                            >
                                                {loading ? "Updating..." : "Edits Prompts"}
                                                {!loading && <ArrowUpRight size={14} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />}
                                            </Button>
                                        </div>
                                    </form>
                                </Surface>
