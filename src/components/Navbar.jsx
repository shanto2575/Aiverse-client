      ...
      <nav className="w-full bg-[#ebdcc9] border border-[#dfcbaf] rounded-full px-6 py-3 shadow-md md:shadow-lg flex items-center justify-between transition-all duration-300">
        ...
        <div className="flex items-center gap-6">
          <div className="hidden sm:flex items-center gap-6 text-sm font-semibold text-[#2c221e]">
            <Link 
              href="/" 
              className={`hover:opacity-80 transition-opacity ${isActive('/') ? 'underline underline-offset-4 decoration-2' : ''}`}
            >
              Home
            </Link>
            <Link 
              href="/all-prompts" 
              className={`hover:opacity-80 transition-opacity ${isActive('/all-prompts') ? 'underline underline-offset-4 decoration-2' : ''}`}
            >
              All Prompts
            </Link>
          </div>
